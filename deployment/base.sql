...
GRANT ALL ON pool.* TO pool@`127.0.0.1` IDENTIFIED BY 'ww2233dsdsdefrgetrg';
GRANT ALL ON pool.* TO pool@localhost IDENTIFIED BY 'ww2233dsdsdefrgetrg';
FLUSH PRIVILEGES;
USE pool;
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'port', '28888', 'int', 'Graft Daemon RPC Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'port', '4020', 'int', 'Graft Daemon RPC Wallet Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'pplnsFee', '0.1', 'float', 'Fee charged for the usage of the PPLNS pool');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'exchangeMin', '50000', 'float', 'Minimum GRF balance for payout to exchange/payment ID');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'walletMin', '10000', 'float', 'Minimum GRF balance for payout to personal wallet');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'devDonation', '0', 'float', 'Donation to GRF core development');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feesForTXN', '5000', 'int', 'Amount of GRF that is left from the fees to pay miner fees.');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'maxTxnValue', '500000', 'int', 'Maximum amount of GRF to send in a single transaction');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'mixIn', '12', 'int', 'Mixin count for coins that support such things.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewAmount', '200', 'float', 'Amount to charge for the txn fee');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewEnd', '1000', 'float', 'Value at which txn fee amount drops to 0');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'shareHost', 'http://165.227.152.155/leafApi', 'string', 'Host that receives share information');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'emailSig', 'http://etnxpool.com', 'string', 'Signature line for the emails.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'priority', '1', 'int', 'Payout priority setting.');
INSERT INTO pool.users (username, pass, email, admin, payout_threshold) VALUES ('admin', null, 'Password123', 1, 0);
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool', 'geoDNS', 'mine.etnxpool.com', 'string', 'geo dns');
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (3333, 2000, 'Low-End Hardware (Up to 30-40 h/s)', 'pplns', 0, 0);
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (5555, 10000, 'Medium-Range Hardware (Up to 160 h/s)', 'pplns', 0, 0);
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (6666, 20000, 'High-End Hardware (Up to 300 h/s)', 'pplns', 0, 0);
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (9000, 20000, 'Clymore SSL', 'pplns', 0, 1);
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (7777, 50000, 'High-End plus Hardware (Anything else!)', 'pplns', 0, 0);
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (8888, 750000, 'Nicehash', 'pplns', 0, 0);
