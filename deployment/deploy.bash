...
cd ~
git clone https://github.com/freebet/paravan-nodejs-pool.git nodejs-pool  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
#cd /usr/local/src
#sudo git clone https://github.com/electronero/electronero.git
#cd electronero
#sudo make -j$(nproc)
#sudo cp ~/nodejs-pool/deployment/etnx.service /lib/systemd/system/
#sudo useradd -m etnxdaemon -d /home/etnxdaemon
#BLOCKCHAIN_DOWNLOAD_DIR=$(sudo -u etnxdaemon mktemp -d)
#sudo systemctl daemon-reload
#sudo systemctl enable etnx
#sudo systemctl start etnx
...
cd ~
git clone https://github.com/freebet/paravan-poolui.git poolui
cd poolui
npm install
